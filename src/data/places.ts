...
export const defaultPlaces: Place[] = [
  // Stadi
  { id: "1", name: "Stadio Olimpico", category: "stadi", lat: 41.9341, lng: 12.4547, description: "La casa della Roma dal 1953. Capacità 72.698 posti. Teatro di infinite emozioni giallorosse.", address: "Viale dei Gladiatori, 00135 Roma", image: "https://images.unsplash.com/photo-1522778526097-ce0a22ceb253?w=800" },
  { id: "2", name: "Centro Sportivo Fulvio Bernardini", category: "stadi", lat: 41.7844, lng: 12.4692, description: "Il centro di allenamento della prima squadra a Trigoria, cuore pulsante del calcio romanista.", address: "Via di Trigoria, 00128 Roma", image: "https://images.unsplash.com/photo-1529629468155-b1cdc9a58d7c?w=800" },
  { id: "3", name: "Stadio Tre Fontane", category: "stadi", lat: 41.8303, lng: 12.4714, description: "Casa della Roma Femminile e della Primavera giallorossa.", address: "Via delle Tre Fontane, 00144 Roma", image: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=800" },
  ...
  // Musei
  { id: "18", name: "Musei Vaticani", category: "musei", lat: 41.9065, lng: 12.4536, description: "Uno dei musei più grandi del mondo con la Cappella Sistina.", address: "Viale Vaticano, 00165 Roma", image: "https://images.unsplash.com/photo-1534709031508-a68cd8f7c56a?w=800" },
  { id: "19", name: "Galleria Borghese", category: "musei", lat: 41.9142, lng: 12.4922, description: "Capolavori di Bernini, Caravaggio e Raffaello in Villa Borghese.", address: "Piazzale Scipione Borghese, 5, 00197 Roma", image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800" },
  ...
  // Shopping
  { id: "22", name: "AS Roma Store - Via del Corso", category: "shopping", lat: 41.9029, lng: 12.4802, description: "Il flagship store ufficiale della Roma nel cuore della città.", address: "Via del Corso, 34, 00186 Roma", image: "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=800" },
  ...
  // Ristoranti
  { id: "25", name: "Trattoria della Lupa", category: "ristoranti", lat: 41.8894, lng: 12.4700, description: "Cucina romana tradizionale nel cuore di Trastevere. Cacio e pepe leggendaria.", address: "Via della Lungaretta, 101, 00153 Roma", image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800" },
  { id: "26", name: "Da Enzo al 29", category: "ristoranti", lat: 41.8867, lng: 12.4689, description: "Osteria storica con i migliori piatti della tradizione romanesca.", address: "Via dei Vascellari, 29, 00153 Roma", image: "https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?w=800" },
  { id: "27", name: "Roscioli", category: "ristoranti", lat: 41.8947, lng: 12.4736, description: "Salumeria e ristorante gourmet, tempio della carbonara.", address: "Via dei Giubbonari, 21, 00186 Roma", image: "https://images.unsplash.com/photo-1579684947550-22e945225d9a?w=800" },
  
  // Locali
  { id: "28", name: "Bar Romanista Testaccio", category: "locali", lat: 41.8753, lng: 12.4764, description: "Il ritrovo storico dei tifosi giallorossi prima delle partite.", address: "Via di Monte Testaccio, 00153 Roma", image: "https://images.unsplash.com/photo-1543007630-9710e4a00a20?w=800" },
  { id: "29", name: "Pub The Yellow", category: "locali", lat: 41.9014, lng: 12.4992, description: "Birra artigianale e maxischermo per tutte le partite della Roma.", address: "Via Cavour, 158, 00184 Roma", image: "https://images.unsplash.com/photo-1575037614876-c38a4c44f5bd?w=800" },
